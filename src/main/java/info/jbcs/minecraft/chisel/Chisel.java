...
public class Chisel {
    ...
    public static final SoundType soundHolystoneFootstep = new StepSoundEx(
            "chisel:holystone", "chisel:holystone", "chisel:holystone", 1.0f);
    public static final SoundType soundTempleFootstep = new StepSoundEx(
            "dig.stone", "chisel:temple-footstep", "dig.stone", 1.0f);
    public static final SoundType soundMetalFootstep = new StepSoundEx(
