...
public class RenderBlocksCTM extends RenderBlocks {
    ...
    public double[] X = new double[26];
    public double[] Y = new double[26];
    public double[] Z = new double[26];
    ...
    public boolean renderStandardBlockCTM(Block block, int x, int y, int z) {
        bx = x;
        by = y;
        bz = z;
